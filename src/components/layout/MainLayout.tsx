...
const ROLE_CONFIGS: Record<string, any> = {
  ...
  builder: { name: "Vickie", roleLabel: "Builder", badge: "System", nav: [ { icon: LayoutDashboard, label: "Dashboard", href: "/builder/dashboard" }, { icon: Calendar, label: "Calendar", href: "/builder/calendar" }, { icon: Database, label: "Database", href: "/builder/database" }, { icon: Activity, label: "Recent Activities", href: "/builder/activities" }, { icon: Clock, label: "Sessions", href: "/builder/sessions" }, { icon: TerminalSquare, label: "Audit Logs", href: "/builder/audit-logs" }, { icon: AlertCircle, label: "Error Logs", href: "/builder/error-logs" }, { icon: Server, label: "System Logs", href: "/builder/system-logs" }, { icon: Megaphone, label: "Announcements", href: "/builder/announcements" }, { icon: MessageSquare, label: "Messages", href: "/builder/messages" }, { icon: Users, label: "User Management", href: "/builder/users" }, { icon: ShieldAlert, label: "Password Reminders", href: "/builder/password-reminders" }, { icon: Ticket, label: "Support Tickets", href: "/builder/support-tickets" } ] }
};

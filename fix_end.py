...
# Let's remove everything after "Assigned Programs" and replace it
pattern = r"<h3 className=\"font-title font-bold text-on-surface mb-4\">\s*Assigned Programs\s*</h3>.*"

replacement = """<h3 className="font-title font-bold text-on-surface mb-4">
                  Assigned Programs
               </h3>

...
import { 
  ...
  LayoutDashboard, School, MessageSquare, Calendar, Users, Bell, Flower2, BookOpen, Settings, Megaphone, Newspaper, ChevronDown, Check, LogOut, Database, Folder, KeyRound, Clock, Activity, TerminalSquare, RefreshCcw, Server, ShieldAlert, AlertCircle,
...
export default function MainLayout() {
  ...
  const hasAccessToPathRole = isUtilityRoute || resolvedAvailableRoles.includes(pathRoleKey) || (userInfo && userInfo.role === pathRoleKey);
